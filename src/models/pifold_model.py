...
class PiFold_Model(nn.Module):
    def __init__(self, args, **kwargs):
        ...
        self.token_mask = torch.ones(args.vocab, dtype=torch.bool)
        prior_matrix = [
        ...
        self.decoder = MLPDecoder(hidden_dim, hidden_dim, args.num_decoder_layers1, args.kernel_size1, args.act_type, args.glu, vocab=self.args.vocab)
    ...
    def forward(self, batch):
        batch = self._get_features(batch)
    ...
    def _get_features(self, batch):
        S, Q, score, X, mask, chain_mask, chain_encoding = batch['S'], batch['Q'], batch['score'], batch['X'], batch['mask'], batch['chain_mask'], batch['chain_encoding']
        ...
        Q = torch.masked_select(Q, mask_bool)
